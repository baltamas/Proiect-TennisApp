...
using TennisApp.ViewModels.AuthenticationViewModels;
...
{   [Route("api/[controller]")]
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("register")] // api/authentication/register -> asta o sa fie ruta in localhost
        ...
        public async Task<ActionResult> ConfirmUser(ConfirmUserRequest confirmUserRequest)
        {
            var toConfirm = _context.ApplicationUsers
                .Where(u => u.Email == confirmUserRequest.Email && u.SecurityStamp == confirmUserRequest.ConfirmationToken).FirstOrDefault();
